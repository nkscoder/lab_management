...
--
-- Host: localhost
-- Generation Time: Apr 25, 2017 at 11:00 PM
...
INSERT INTO `account` (`id`, `username`, `email`, `password`, `createdon`, `verifiedon`, `lastsignedinon`, `resetsenton`, `deletedon`, `suspendedon`, `verificationstatus`, `verificationcode`) VALUES
(1, 'admin', 'admin@lms.com', '$2a$08$kNiy3tfhwSj8ifs96qgbpuCFgjYnbuTPRKTMO8jvClczbOlNa7fj6', '2015-08-27 10:33:19', NULL, '2017-04-25 20:18:35', '2016-03-22 07:04:26', NULL, NULL, 'active', NULL),
(3, 'staff', 'staff@lms.com', '$2a$08$ixd.Bu8gYb8NP1/BjbbeTuhB1JCBEoXnDlPAmYduZYXjj46QKM9du', '2016-03-17 10:32:08', NULL, '2017-04-22 20:45:33', NULL, NULL, NULL, 'active', NULL);
...
INSERT INTO `account_details` (`account_id`, `fullname`, `firstname`, `lastname`, `dateofbirth`, `gender`, `phone`, `address`, `state`, `city`, `postalcode`, `country`, `language`, `timezone`, `citimezone`, `picture`) VALUES
(1, 'admin', 'admin', NULL, '2004-01-05', 'M', NULL, NULL, NULL, NULL, '500090', 'in', 'te', 'Asia/Kolkata', NULL, NULL),
(3, 'staff', 'staff', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `acl_permission` (`id`, `key`, `description`, `suspendedon`, `is_system`, `system_access_only`) VALUES
(15, 'manage_appointments', 'Using this module one can mange appointments', NULL, 1, 0),
(16, 'manage_doctors', 'Using this module one can manage doctors', NULL, 1, 0),
(17, 'manage_tests', 'Using this module one can manage tests', NULL, 1, 0),
(18, 'manage_sitesettings', 'Using this module one can manage site settings informations', NULL, 1, 0),
(19, 'manage_users', 'Using this module one can manage users', NULL, 1, 0),
(20, 'manage_roles', 'Using this module one can manage roles', NULL, 1, 0),
(21, 'manage_permissions', 'Using this module one can manage permissions to users', NULL, 1, 0),
(22, 'reports', 'Reports module gives over all business financial and appointments informations', NULL, 1, 0),
(23, 'manage_emailsettings', 'Using this module one can manage email communications of the business', NULL, 1, 0);
...
(3, 'Staff', 'Staff is an employee under administrator who has access to the system to  manage operations based on permissions given by administrator.', NULL, 1);
...
CREATE TABLE IF NOT EXISTS `appointments` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='all the appointments are stored in this table' AUTO_INCREMENT=4 ;

--
-- Dumping data for table `appointments`
--

INSERT INTO `appointments` (`id`, `user_id`, `reference_no`, `name`, `age`, `sex`, `phone`, `email_id`, `test`, `test_price`, `discount`, `total_price`, `sample_collection_time`, `appointment_date`, `doctor_ref_by`, `appointment_status`, `report_doc`, `payment_status`) VALUES
(1, 1, '58ff6227898ad', 'Ravi Kumar', 55, 'male', '9856478542', 'ravi@gmail.com', 2, 500.00, 10, 490.00, '3:30 AM', '2017-04-25', 'sitesh sitesh', 'generated', '', 'paid'),
(2, 1, '58ff65502cf48', 'S kumar', 55, 'female', '9875698754', 'jjjjjj@gmail.com', 2, 500.00, 88, 412.00, '8:00 AM', '2017-04-25', 'Mr Vivek Kumar', 'inprogress', '', 'paid'),
(3, 1, '58ff7e9bb9f6b', 'kfkhgf', 33, 'female', '98756566666', 'jfkljgf@gmail.com', 2, 500.00, 30, 470.00, '4:00 AM', '2017-04-25', 'sitesh sitesh', 'pending', '', 'paid');
...
('a85a0659f2350cc689358a839399e4b2', '127.0.0.1', 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:52.0) Gecko/20100101 Firefox/52.0', 1493140778, 'a:4:{s:9:"user_data";s:0:"";s:10:"account_id";s:1:"1";s:8:"username";s:5:"admin";s:10:"user_image";N;}');
...
INSERT INTO `doctors` (`id`, `surname`, `name`, `medical_licence_no`, `specialization`, `phone`, `status`) VALUES
(1, 'sitesh', 'sitesh', '12345', 'Obstetrician', '9898989898', 'active'),
(2, 'Mr', 'Vivek Kumar', '123456', 'Neurologist', '9856421535', 'active');
...
INSERT INTO `email_settings` (`id`, `protocol`, `path_to_send_mail`, `smtp_host`, `smtp_port`, `smtp_user`, `smtp_password`) VALUES
(1, 'smtp', '/usr/sbin/smtp', 'smtp.gmail.com', '465', 'developer.kalyankrishna@gmail.com', '');
...
INSERT INTO `ref_currency` (`alpha`, `numeric`, `currency`) VALUES
('AED', '784', 'UAE Dirham'),
('AFN', '971', 'Afghani'),
('ALL', '8', 'Lek'),
...
INSERT INTO `sitesettings` (`id`, `site_name`, `site_phone`, `site_email`, `site_address`, `site_city`, `site_state`, `site_country`, `site_pincode`, `site_currency`) VALUES
(1, 'LAB MANAGEMENT', '7386896258', 'medlab@gmail.com', '1391, 3rd floor', 'hyderabad', 'telangana', 'india', '500090', '$');
...
INSERT INTO `tests` (`id`, `test_name`, `test_description`, `test_price`, `status`) VALUES
(1, 'ABC', 'Test', 300.00, 'active'),
(2, 'Test', 'test', 500.00, 'active'),
(3, 'Test 2', 'test ', 800.00, 'active'),
(4, 'Test', 'test', 500.00, 'active'),
(5, 'Test 4', 'test ', 1000.00, 'active');
...
ALTER TABLE `account_details`
  ADD CONSTRAINT `account_details_ibfk_1` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON UPDATE CASCADE;
