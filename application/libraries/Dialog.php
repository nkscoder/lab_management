...
class Dialog {
    ...
    protected $dailog_layout = 'dialog';
    ...
    /**
     * Set dialog dailog_layout
     *
     * @access  public
     * @param   string  $dailog_layout
     * @return  void
     */
    public function set_dailog_layout($dailog_layout) 
    {   
            $this->dailog_layout = $dailog_layout;
    ...
    public function html()
    {
        ...
        return $this->_ci->load->view($this->dailog_layout, $this->data, TRUE);
    }
}
