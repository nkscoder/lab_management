...
class Sign_up extends MY_Controller {
	...
	function __construct()
	{
		...
		$this->load->model(array('account/account_model', 'account/account_details_model','account/rel_account_role_model'));
	...
	function index()
	{
		...
		$this->form_validation->set_rules(array(array('field' => 'sign_up_username', 'label' => 'lang:sign_up_username', 'rules' => 'trim|required|alpha_dash|min_length[2]|max_length[24]'), array('field' => 'sign_up_password', 'label' => 'lang:sign_up_password', 'rules' => 'trim|required|min_length[6]'), array('field' => 'sign_up_confirm_password', 'label' => 'lang:sign_up_confirm_password', 'rules' => 'trim|required|matches[sign_up_password]|min_length[6]'), array('field' => 'sign_up_email', 'label' => 'lang:sign_up_email', 'rules' => 'trim|required|valid_email|max_length[160]')));
...
APPSCRIPT;
		...
		$this->template->load_view('sign_up', isset($this->data) ? $this->data : NULL);
	}
