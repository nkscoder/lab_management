...
class Rel_account_permission_model extends CI_Model {
  ...
  function get()
  {
    return $this->db->get('rel_account_permission')->result();
  }
  ...
  function get_by_account_id($account_id)
  {
    ...
    $this->db->from('rel_account_permission');
    $this->db->join('acl_permission', 'rel_account_permission.permission_id = acl_permission.id');
    $this->db->where("rel_account_permission.account_id = $account_id AND acl_permission.suspendedon IS NULL");
  ...
  function update($account_id, $permission_id)
  {
    ...
    {
      $this->db->insert('rel_account_permission', array('account_id' => $account_id, 'permission_id' => $permission_id));
    }
  }
  ...
  {
    $this->db->delete('rel_account_permission', array('account_id' => $account_id, 'permission_id' => $permission_id));
  }
  ...
  {
    $this->db->delete('rel_account_permission', array('account_id' => $account_id));
  }
  ...
  {
    $this->db->delete('rel_account_permission', array('permission_id' => $permission_id));
  }
}