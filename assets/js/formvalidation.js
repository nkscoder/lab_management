            ...
            new FormValidator(formName, rules, function(errors, event) {
                ...
                if (errors.length > 0) {
                    ...
                    for (var i = 0; i < errors.length; i++) {
                       ...
                       // $form.find($('#' + error.id).closest('.form-group'))
                       //              .after('<p class="help-block error">' + message + '</p>');
                                   
                                    
                        $form.find('#' + error.id)
                            .after('<p class="help-block">' + message + '</p>')
                                .closest('.form-group').addClass('small has-error');
                    }
